...
public interface IPowerManager extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IPowerManager {
        ...
        private static class Proxy implements IPowerManager {
            ...
            public void acquireWakeLock(IBinder lock, int flags, String tag) throws RemoteException {
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                case 1:
                    ...
                    acquireWakeLock(data.readStrongBinder(), data.readInt(), data.readString());
    ...
    void acquireWakeLock(IBinder iBinder, int i, String str) throws RemoteException;
