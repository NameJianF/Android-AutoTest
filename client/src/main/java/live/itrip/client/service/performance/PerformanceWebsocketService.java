...
public class PerformanceWebsocketService extends Service<String> {
    ...
    private PerformanceWebsocketTask clientTask;
    ...
    protected Task<String> createTask() {
        clientTask = new PerformanceWebsocketTask(getName());
        try {
